...
const PID = "15";
const pairAddress = "0x014608E87AF97a054C9a49f81E1473076D51d9a3";
...
let contract: any;
let MasterChefLPnative: MasterChefStrategyLPNative;
...
async function main() {
  ...
  try {
    ...
    MasterChefLPnative = await contract.deploy(
      WETHAddress,
      pairAddress,
      CakeAddress,
      masterChef,
    ...
    console.log("MasterChefLPnative ", MasterChefLPnative.address);
  } catch (error) {
    console.log(error);
  }
}
