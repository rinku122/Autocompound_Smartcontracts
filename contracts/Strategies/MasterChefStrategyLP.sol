...
contract MasterChefStrategyLP is MasterChefStrategy {
        ...
        nonReentrant
    {
        require(
            _token == address(token0) || _token == address(token1),
            "MasterChefStrategyLP::singleWithdraw: Invalid token address"
        );
    ...
    function reinvest() external onlyEOA nonReentrant {
        ...
        require(
            ...
            "MasterChefStrategyLP::reinvest: MIN_TOKENS_TO_REINVEST"
        );
    ...
    function reinvestOps() external onlyOps nonReentrant {
        ...
        require(
            unclaimedRewards >= MIN_TOKENS_TO_REINVEST,
            "MasterChefStrategyLP::reinvestOps: MIN_TOKENS_TO_REINVEST"
        );
        ...
        returns (uint256)
    {
        ...
        require(
            amountIn > 0,
            "MasterChefStrategyLP::_convertRewardTokensToDepositTokens: amount too low"
        );
    ...
    function _deposit(uint256 amount, bool check) internal {
        require(
            ...
            "MasterChefStrategyLP::_deposit: deposit failed"
        );
